...
$string['authpassword'] = 'Contrasenya HTTP';
$string['authpassworddesc'] = 'Es necessita una contrasenya (HTTP basic auth) per accedir a aquesta alimentació (si cal)';
$string['authuser'] = 'nom d\'usuari HTTP';
$string['authuserdesc'] = 'Es necessita un nom d\'usuari (HTTP basic auth) per accedir a aquesta alimentació (si cal)';
...
$string['publishedon'] = 'Publicat a %s';

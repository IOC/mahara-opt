...
$string['description'] = 'Afegiu fragments de text a la vostra pàgina';
$string['optionlegend'] = 'Converteix blocs "Annotació"';
$string['switchdescription'] = 'Converteix tots els blocs "Anotació" que no usen característiques avançades en simples blocs de "Text"';
$string['title'] = 'Text';

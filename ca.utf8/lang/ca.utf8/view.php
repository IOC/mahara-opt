...
$string['addarow'] = 'Afegeix una fila';
...
$string['blockorderafter'] = 'Després de "%s"';
$string['blockordertop'] = 'Part superior de la columna';
...
$string['cellposition'] = 'Fila %s Columna %s';
...
$string['changerowlayoutfailed'] = 'No s\'ha pogut canviar la disposició. Algú més deu haver editat la disposició al mateix moment que vós. Proveu-ho més tard.';
...
$string['columnlayout'] = 'Disposició personalitzada';
...
$string['copyfornewmembersdescription1'] = 'Fes automàticament una còpia de les pàgines/col·leccions seleccionades per a tots els nous membres de %s.';
$string['copyfornewusers'] = 'Copia pels usuaris nous';
$string['copyfornewusersdescription1'] = 'Cada cop que es crei un usuari nou fes automàticament una còpia personal de les pàgines o col·leccions seleccionades al portafolis de l\'usuari.';
...
$string['createcustomlayout'] = 'Crea una disposició personalitzada';
$string['createemptyview'] = 'Crea una pàgina buida';
$string['createnewlayout'] = 'Crea una disposició nova.';
...
$string['image'] = 'Imatge';
$string['imagetooltip'] = 'Afegeix una imatge';
$string['in'] = 'a';
...
$string['layoutpreview'] = 'Vista prèvia de la disposició';
...
$string['removethisrow'] = 'Elimina aquesta fila';
...
$string['retainviewrightsdescription1'] = 'Marqueu aquesta casella si voleu afegir el vostre accés a veure còpies de les pàgines o col·leccions seleccionades  a les còpies que en fan els altres usuaris. Els usuaris podran revocar aquest accés més endavant si així ho desitgen. Les pàgines que es copien d\'una còpia d\'aquesta pàgina o col·lecció no tindrà aquest mateix accés.';
$string['retainviewrightsgroupdescription1'] = 'Marqueu aquesta casella si voleu afegir l\'accés als membres d\'aquest grup a veure les còpies de les pàgines  o col·leccions seleccionades que altres usuaris copiaran. Els usuaris poden revocar aquest accés més endavant si així ho desitgen. Les pàgines que es copien d\'una còpia d\'aquesta pàgina o col·lecció no tindrà aquest mateix accés.';
...
$string['submitthiscollectionto'] = 'Tramet aquesta col·lecció a';
...
$string['templatedescriptionplural1'] = 'Marqueu aquesta casella si voleu que les persones que poden veure les vostres pàgines o col·leccions seleccionades puguin fer-ne les seves pròpies còpies, juntament amb els arxius i les carpetes que contenen.';
$string['textbox'] = 'Bloc de text';
$string['textboxtooltip'] = 'Afegeix un bloc de text';
$string['theme'] = 'Tema';
...
$string['viewcolumnspagedescription'] = 'Primer, seleccioneu el nombre de columnes de la pàgina. En el pas següent podreu canviar l\'amplada de les columnes.';
...
$string['views'] = 'pàgines';
$string['viewsalreadysubmitted'] = 'Ja s\'havien enviat algunes pàgines d\'aquesta col·lecció: <br>%s<br> No podeu enviar la col·lecció sencera fins que no s\'hagin publicat.';

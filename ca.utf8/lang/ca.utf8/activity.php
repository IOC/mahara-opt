...
$string['attime'] = 'a';
$string['blockinstancenotification'] = 'S\'ha afegit o canviat el bloc "%s"';
$string['date'] = 'Data';
$string['deleteallnotifications'] = 'Esborra totes les notificacions';
$string['deletednotifications1'] = array(
    0 => 'S\'ha esborrat %s notificació',
    1 => 'S\'han esborrat %s notificacions',
);
...
$string['messagetype'] = 'Tipus de missatge';
$string['missingparam'] = 'Al tipus d\'activitat %s li manca el paràmetre obligatori %s';
$string['monitored'] = 'En seguiment';
$string['newcollectionaccessmessage'] = '%s us ha afegit a la llista d\'accés de la col·lecció "%s"';
$string['newcollectionaccessmessagenoowner'] = 'Se us ha afegit a la llista d\'accés de la col·lecció "%s"';
$string['newcollectionaccessmessagenoownerviews'] = 'Se us ha afegit a la llista d\'accés de les pàgines "%s" de la col·lecció "%s"';
$string['newcollectionaccessmessageviews'] = '%2$s us ha afegit a la llista d\'accés a les pàgines "%s" de la col·lecció "%3$s"';
$string['newcollectionaccesssubject'] = 'Nou accés a la col·lecció "%s"';
...
$string['newviewaccessmessage'] = 'Heu sigut afegit a la Pàgina anomenada "%s" per %s';
$string['newviewaccessmessagenoowner'] = 'Heu sigut admès per accedir a la llista  "%s"';
$string['newviewaccessmessagenoownerviews'] = 'Se us ha afegit a la llista d\'accés de les pàgines "%s"';
$string['newviewaccessmessageviews'] = '%s us ha afegit a la llista d\'accés a les pàgines "%s"';
$string['newviewaccesssubject1'] = 'Nou accés a la pàgina "%s"';
$string['newviewaccesssubjectviews'] = 'Nou accés a les pàgines "%s"';
...
$string['newwatchlistmessageview1'] = 'La pàgina "%s" que pertany a %s ha canviat';
$string['nodelete'] = 'No hi ha cap notificació per esborrar';
$string['nonamegiven'] = 'no s\'ha donat cap nom';
...
$string['selectalldelete'] = 'Totes les notificacions per eliminar';
$string['selectallread'] = 'Totes les notificacions no llegides';
...
$string['typenewpost'] = 'Entrada al fòrum';

...
$string['mobileuploadnotenabled'] = 'No estan habilitades les càrregues des dels mòbils';
$string['mobileuploadtokennotfound'] = 'No s\'ha trobat el token (testimoni d\'autenticació)  de càrrega des del mòbil. Comproveu la configuració de l\'aplicació del mòbil.';
$string['mobileuploadtokennotset'] = 'El vostre token pel mòbil (testimoni d\'autenticació) no pot estar en blanc. Comproveu la configuració de l\'aplicació del mòbil i torneu-ho a provar.';
$string['mobileuploadusernamenotset'] = 'El vostre nom d\'usuari per les càrregues des del mòbil no pot estar en blanc. Comproveu la configuració de l\'aplicació del mòbil i torneu-ho a provar.';

...
$string['mobileuploadtokennotfound'] = 'No s\'ha trobat el testimoni d\'autenticació de càrrega des del mòbil. Comproveu la configuració de l\'aplicació del mòbil.';
$string['mobileuploadtokennotset'] = 'El vostre testimoni d\'autenticació pel mòbil no pot estar en blanc. Comproveu la configuració de l\'aplicació del mòbil i torneu-ho a provar.';

...
$string['tagsdesc'] = 'Cerqueu o escriviu una etiqueta per aquest element.';
$string['tagsdescprofile'] = 'Cerqueu o escriviu una etiqueta per aquest element. Els elements etiquetats com a \'perfil\' es mostraran a la vostra barra lateral.';

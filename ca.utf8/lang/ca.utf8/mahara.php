...
$string['All'] = 'Tot';
$string['Allinstitutions'] = 'Totes les institucions';
...
$string['From'] = 'De';
$string['Help'] = 'Ajuda';
$string['Hide2'] = 'Amaga la caixa d\'informació';
...
$string['accesstotallydenied_institutionsuspended'] = 'S\'ha suspès la vostra institució %s. Fins que s\'aixequi la suspensió no us podreu registrar a %s.
...
$string['allonline'] = 'Mostra tots els usaris  en línia';
...
$string['at'] = 'a';
$string['attachedimage'] = 'Imatge adjunta';
...
$string['cantbedeleted'] = 'Aquest artefacte no es pot esborrar perquè ell, o parts d\'ell, estan en pàgines que ja han estat enviades.';
$string['cantchangepassword'] = 'No podeu canviar la contrasenya des d\'aquesta interfície. Utilitzeu la de la vostra institució';
$string['cantmoveitem'] = 'No es pot moure aquest artefacte';
...
$string['chooseinstitution'] = 'Escolliu la vostra institució';
...
$string['clamnotset'] = 'Heu activat la cerca de virus però no heu configurat el valor "Camí al ClamAV". La cerca de virus no s\'activarà fins que configureu el camí al ClamAV tot donant un valor a $cfg->pathtoclam del vostre fitxer de configuració config.php';
...
$string['clickformore'] = '(Premeu \'entrar\' per mostrar més informació)';
$string['closehelp'] = 'Tanca l\'ajuda';
$string['collapse'] = 'Redueix';
$string['complaint'] = 'Queixa';
$string['complete'] = 'Completa';
$string['config'] = 'Configuració';
$string['configfor'] = 'Configuració per a';
...
$string['copy'] = 'Copia';
$string['copytoclipboard'] = 'Copia la URL secreta al porta-retalls';
...
$string['deletespecific'] = 'Elimina "%s"';
...
$string['done'] = 'Fet';
$string['dropdownmenu'] = 'menú';
$string['earliest'] = 'El més antic';
$string['edit'] = 'Edita';
...
$string['emails'] = 'Correus electrònics';
...
$string['forgotusernamepasswordtextprimaryemail'] = '<p>Si no recordeu el vostre nom d\'usuari o contrasenya, introduïu l\'adreça de correu electrònic principal que apareix al vostre perfil i us enviarem un missatge que podeu utilitzar per aconseguir una nova contrasenya. </p>
<p>Si sabeu el nom d\'usuari però heu oblidat la contrasenya, també podeu introduir el nom d\'usuari en lloc de l\'adreça de correu. </p>';
...
$string['general'] = 'Opcions generals';
$string['go'] = 'Ves a';
$string['goto'] = 'Ves a \'%s\'';
$string['gotoinbox'] = 'Vés a la safata d\'entrada';
$string['gotomore'] = 'Saber-ne més...';
$string['groupquota'] = 'Quota de grup';
$string['groups'] = 'Grups';
$string['height'] = 'Alçada';
$string['heightshort'] = 'alç';
$string['helpfor'] = 'Ajuda sobre "%s"';
$string['hidden'] = 'ocult';
$string['hide'] = 'Amaga';
...
$string['image'] = 'Imatge';
$string['imagexofy'] = 'Imatge {x} of {y}';
$string['importedfrom'] = 'Importat de %s';
$string['inbox'] = 'Safata d\'entrada';
$string['inboxblocktitle'] = 'Safata d\'entrada';
...
Cal que netegeu comptes d\'usuari o demaneu un increment del nombre màxim d\'usuaris de la vostra institució. Qualsevol dels administradors del lloc us ho podrà fer.

Salutacions,
L\'equip %s';
$string['institutionmembershipfullsubject'] = 'S\'ha assolit la quota de membres de la institució.';
...
$string['lastupdateorcomment'] = 'Darrera actualització o comentari';
$string['latest'] = 'L\'últim';
$string['leaveinstitution'] = 'Abandonar la institució';
$string['license'] = 'Llicència';
$string['licensedesc'] = 'Llicència d\'aquest contingut';
$string['licensemandatoryerror'] = 'El camp de la llicència és obligatori';
$string['licensenocustomerror'] = 'Aquest tipus de llicència no és permès en aquest lloc.';
$string['licensenone'] = 'Cap seleccionada';
$string['licensenonedetailed'] = '%s no ha escollit cap llicència per aquest contingut';
$string['licensenonedetailedowner'] = 'No heu escollit cap llicència per aquest contingut';
$string['licenseother'] = 'Altres llicències (escriviu la URL)';
$string['licenseotherurl'] = 'Introduïu la URL';
$string['licensingadvanced'] = 'Llicència avançada';
$string['licensor'] = 'Llicenciador';
$string['licensordesc'] = 'Llicenciador original d\'aquest contingut';
$string['licensorurl'] = 'URL original';
$string['licensorurldesc'] = 'URL original d\'aquest contingut';
$string['link'] = '<a href="%s">%s</a>';
$string['linksandresources'] = 'Enllaços i recursos';
$string['loading'] = 'Carregant ...';
$string['loggedinusersonly'] = 'Només ususaris registrats';
...
$string['maxitemsperpage1'] = 'Resultats per pàgina';
...
$string['more...'] = 'Més ...';
$string['move'] = 'Mou';
$string['moveitemdown'] = 'Mou cap avall';
$string['moveitemup'] = 'Mou cap amunt';
...
$string['newuserscantpostlinksorimages'] = 'Els usuaris acabats de registrar no tenen permisos per enviar enllaços. Torneu a redactar la vostra entrada i esborreu tots els enllaços o URLs i envieu-lo un  altre cop.';
$string['next'] = 'Següent';
...
$string['noinstitutionadminfound'] = 'No s\'han trobat administradors de la institució';
$string['noinstitutionoldpassemailmessagehtml'] = '<p>Benvolgut/uda %s,</p>

<p>Ja no sou membre de %s.</p>
<p>Podeu continuar utilitzant %s amb el vostre nom d\'usuari actual %s i la contrasenya que ja teniu pel vostre compte.</p>

<p>Si heu oblidat la contrasenya podeu demanar-ne una altra anant a la següent pàgina i escrivint el vostre nom d\'usuari:</p>

<p><a href="%sforgotpass.php">%sforgotpass.php</a></p>

<p>Per qualsevol dubte o pregunta sobre l\'anterior no dubteu en  <a href="%scontact.php">contactar-nos</a>.</p>

<p>Salutacions, %s administrador del lloc</p>

<p><a href="%sforgotpass.php">%sforgotpass.php</a></p>';
$string['noinstitutionoldpassemailmessagetext'] = 'Benvolgut/uda %s,

Ja no sou membre de %s.
Podeu continuar utilitzant %s amb el vostre nom d\'usuari actual %s i la contrasenya que ja teniu pel vostre compte.

Si heu oblidat la contrasenya podeu demanar-ne una altra anant a la següent pàgina i escrivint el vostre nom d\'usuari:
...
%sforgotpass.php';
$string['noinstitutionoldpassemailsubject'] = '%s: Inscripció a %s';
...
$string['noinstitutionstafffound'] = 'No s\'han trobat directius de la institució';
$string['none'] = 'Cap';
$string['noonlineusersfound'] = 'No hi ha cap usuari en línia';
$string['nopathfound'] = 'No s\'ha trobat el camí d\'aquest artefacte';
$string['noprogressitems'] = 'Aquesta institució no té ítems de compleció del perfil.';
$string['nopublishpermissiononartefact'] = 'No teniu permisos per publicar %s';
...
$string['pluginbrokenanddisabled'] = 'Un usuari ha provat de carregar el connector %s però no ha estat possible.
...
';
$string['pluginbrokenanddisabledtitle'] = 'S\'ha desactivat el connector trencat %s';
$string['plugindisabled'] = 'Connector desactivat';
$string['plugindisableduser'] = 'S\'ha desactivat el connector %s. Contacteu amb l\'administrador per tornar-lo a activar.';
...
$string['profilecompleteness'] = 'Compleció del perfil';
$string['profilecompletenesspreview'] = 'Vista prèvia de la compleció del perfil';
$string['profilecompletenesstips'] = 'Suggeriments per la compleció del perfil';
$string['profilecompletionforwhichinstitution'] = 'per';
...
$string['profileimagetext'] = 'Imatge del perfil de %s';
$string['profileimagetextanonymous'] = 'Imatge del perfil anònima';
...
$string['quotausagegroup'] = 'Aquest grup ha usat <span id="quota_used">%s</span>  de la seva quota de disc de <span id="quota_total">%s</span>.';
...
$string['selectnone'] = 'No en seleccionis cap';
...
$string['settingsspecific'] = 'Configuració per a "%s"';
$string['show'] = 'Mostra';
...
$string['sizekb'] = 'KB';
$string['sizemb'] = 'MB';
$string['skipmenu'] = 'Vés al contingut principal';
...
$string['sortorder'] = 'Modifica l\'ordre dels fitxers';
...
$string['tagfilter_collection'] = 'Col·leccions';
...
$string['theme'] = 'Tema';
$string['toggletoolbarsoff'] = 'Oculta les barres d\'eines. Mostra només els botons bàsics';
$string['toggletoolbarson'] = 'Mostra les barres d\'eines. Mostra la llista completa de botons';
...
$string['wanttoleavewithoutsaving?'] = 'Heu fet canvis. Voleu abandonar la pàgina sense desar-los?';

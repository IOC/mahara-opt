...
$string['resizeonuploaduserdefault'] = 'Activa per defecte  "Canvia la mida de les imatges grans en pujar-les"';
$string['resizeonuploaduserdefaultdescription'] = 'Marqueu aquesta casella per activar per defecte  l\'opció "Canvia la mida de les imatges grans en pujar-les". Desmarqueu-la per tenir desactivada per defecte aquesta opció .';

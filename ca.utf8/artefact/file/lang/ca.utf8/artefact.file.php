...
$string['downloadfolderzipdescription2'] = 'Si està marcat els usuaris poden descarregar un directori com a fitxer comprimit zip via el bloc de Fitxers';
...
$string['institutionoverridedescription1'] = 'Si està marcat permetreu als administradors de la institució a què fixin les quotes de fitxers dels usuaris de la seva institució.';
...
$string['quotanotifyadmindescr2'] = 'Si està marcat els administradors del lloc rebran notificacions quan els usuaris assoleixin el llindar de notificacions.';
...
$string['resizeonuploadenabledescription2'] = 'Si està marcat les imatges grans canviaran de mida en ser carregades i excedeixen l\'alçada i amplada màximes.';
...
$string['resizeonuploaduseroptiondescription2'] = 'Si està marcat es mostrarà als usuaris l\'opció per activar o desactivar el canvi automàtic de mida de les imatges quan es carreguin.';
...
$string['updategroupquotasdesc1'] = 'Si està marcat la quota per defecte que trieu s\'aplicarà a tots els grups existents.';
$string['updateuserquotas'] = 'Actualitza les quotes dels usuaris';
$string['updateuserquotasdesc1'] = 'Si està marcat la quota per defecte que trieu s\'aplicarà a tots els usuaris existents.';

...
$string['resizeonuploadenable'] = 'Activa el canvi de mida automàtic de les imatges grans';
$string['resizeonuploadenabledescription'] = 'Canvia la mida de les imatges en pujar-les si excedeixen els paràmetres de l\'amplada i alçada màximes.';
$string['resizeonuploadenablefilebrowser'] = 'Activa el canvi de mida automàtic de les imatges més grans de %sx%s px (recomanat)';
$string['resizeonuploadmaxheight'] = 'Alçada màxima';
$string['resizeonuploadmaxwidth'] = 'Amplada màxima';
$string['resizeonuploaduseroption'] = 'Mostra l\'opció';
$string['resizeonuploaduseroptiondescription'] = 'Mostra als usuaris l\'opció d\'habilitar o deshabilitar el canvi de mida automàtic d\'imatges de grans dimensions en pujar-les.';

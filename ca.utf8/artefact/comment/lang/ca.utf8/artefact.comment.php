...
$string['commentonviewbyuser'] = 'Comentari sobre %s de %s';
...
$string['comments'] = 'comentaris';
$string['commentsubmitted'] = 'S\'ha enviat el comentari';
$string['commentsubmittedmoderatedanon'] = 'S\'ha enviat el comentari i s\'està esperant la moderació';
$string['commentsubmittedprivateanon'] = 'S\'ha enviat el comentari provat';
...
$string['ratingexample'] = 'S\'ha generat un exemple';
...
$string['replytonoprivatereplyallowed'] = 'No esteu autoritzat a donar resposta privada a aquest comentari.';
$string['replytonopublicreplyallowed'] = 'No esteu autoritzat a donar resposta pública a aquest comentari.';
$string['star'] = 'Estrella';
$string['thiscommentisprivate'] = 'Aquest comentari és privat';
$string['thumbsup'] = 'Polzes amunt';
$string['typefeedback'] = 'Comentari';
